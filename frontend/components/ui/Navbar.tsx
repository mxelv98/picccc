        ...
        >
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <Link
                        to={user?.role === 'admin' || (user?.vip_status === 'active' && user?.plan_type === 'vip') ? "/elite" : "/plans"}
                        className="text-white bg-pluxo-pink/20 border border-pluxo-pink/30 px-3 py-1 rounded-md hover:bg-pluxo-pink/30 transition-all text-xs font-black uppercase tracking-widest italic"
                    >
                        Elite Mode
                    </Link>
